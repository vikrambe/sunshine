...
public class SchedulerMain{
	...
	public void createNewGenerations(){
		...
		while(nogenerations<maxgenerations){	
			...
			while(i<populationsize){
				...
				//crossover
				if(new Random().nextDouble()< Model.crossoverrate){
	...
	public void customMutation(Chromosome c){
		...
		int geneno=new Random().nextInt(Model.nostudentgroup);
	...
	public Chromosome crossover(Chromosome father,Chromosome mother){
		...
		int randomint=new Random().nextInt(Model.nostudentgroup);
	...
	public void mutation(Chromosome c){
		...
		for(int i = 0; i< Model.daysperweek* Model.hoursperday-1; i++){
			c.gene[geneno].slotno[i]=c.gene[geneno].slotno[i+1];
		}
		c.gene[geneno].slotno[Model.daysperweek* Model.hoursperday-1]=temp;
	}
	...
	public void swapMutation(Chromosome c){
		...
		int geneno=new Random().nextInt(Model.nostudentgroup);
		int slotno1=new Random().nextInt(Model.hoursperday* Model.daysperweek);
		int slotno2=new Random().nextInt(Model.hoursperday* Model.daysperweek);
